...
class DNAVisualizerFinal(QMainWindow):
    ...
    def draw_dna_helix(self):
        ...
        while sequence_index < len(self.sequence):
            ...
            # رسم اتصالات بین بازها (اگر موقعیت قبلی وجود دارد)
            if visual_index > 0:
                ...
                # اتصالات بین رشته‌ها (همه نقاط حتی نقاط تلاقی)
